...
/**
 *
 * Class which serves as the controller for the 6X6 game view
 * */
public class GameScreen6X6Controller extends GameScreen implements Initializable {
    ...
    public void loadImages() {
        ...
        if(getGameTheme() == 1){
            ...
            getImages().add(path + "\\DS-Client\\images-set2\\13.jpg");
            getImages().add(path + "\\DS-Client\\images-set2\\14.jpg");
            getImages().add(path + "\\DS-Client\\images-set2\\15.jpg");
            getImages().add(path + "\\DS-Client\\images-set2\\16.jpg");
            getImages().add(path + "\\DS-Client\\images-set2\\17.jpg");
            getImages().add(path + "\\DS-Client\\images-set2\\18.jpg");
        }
