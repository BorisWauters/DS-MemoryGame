...
public class GameScreen4X6Controller implements Initializable {
    ...
    public void initialize(URL location, ResourceBundle resources) {
        Platform.runLater(() -> {
            ...
            if (cardsTurnedGuessedRightInTotal == 24) {
            ...
            GameScreen.removeCallback(stage, controllerId);
    ...
    public void buttonClicked(ActionEvent actionEvent) throws RemoteException, InterruptedException {
        ...
        for (int i = 0; i < gamePositions.size(); i++) {
            ...
            if (Integer.parseInt(b.getId()) == Integer.parseInt(gamePositions.get(i)) - 1) {
                i++;
                MainClient.impl.updateCardFlip(Integer.parseInt(b.getId()), gameId, controllerId, 2);
            } else {
                i++;
            }
        }
        ...
        if (pressedButton == null) {
            ...
            if (fileLocation.equals(fileLocation2)) {
                ...
                if (cardsTurnedGuessedRightInTotal == 16) {
                    updateGamePositions();
                    MainClient.impl.updateGame(gameId, MainClient.username, gamePositions, correctGuesses.size() / 2, 2);
